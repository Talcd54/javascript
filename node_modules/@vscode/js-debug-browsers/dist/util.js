...
exports.findWindowsCandidates = exports.sort = exports.preferredEdgePath = exports.preferredFirefoxPath = exports.preferredChromePath = exports.escapeRegexSpecialChars = exports.canAccess = void 0;
 ...
 */
async function preferredFirefoxPath(fs, env) {
    if (await canAccess(fs, env.FIREFOX_PATH)) {
        return env.FIREFOX_PATH;
    }
}
exports.preferredFirefoxPath = preferredFirefoxPath;
/**
